...
def _environment(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("S2P_BYTEWAX_FLOW_NAME", "s2p-fetcher-v2")
    monkeypatch.setenv("S2P_BYTEWAX_RECOVERY_NAME", "fetcher-v2")
...
def test_marker_fails_closed_on_identity_drift(
    ...
    changed = {**expected, "flow_name": "s2p-fetcher-v3"}
