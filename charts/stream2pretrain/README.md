...
The chart owns the source pollers, SourceFeed controller, Bytewax processors,
classifier services, Iceberg writer, DuckDB API, Foundry and UI. It also supplies
...
| processor | Curator, Iceberg writer, DuckDB and SourceFeed controller |
...
The SourceFeed schema lives under `crds/`. Helm installs it
