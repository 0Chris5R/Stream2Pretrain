...
| Iceberg metadata | Unauthorized table commit | Polaris credentials, namespace isolation, and a persistent PostgreSQL metastore | The single database replica requires PVC backup and is not an HA database |
