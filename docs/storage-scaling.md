...
SQLite control store is a durable outbox, so an accepted package or audit event
survives a worker restart before the next Iceberg commit. Deterministic duplicate
