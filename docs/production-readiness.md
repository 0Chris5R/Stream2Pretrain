...
| PRD-011 | done | KEDA | Replace self-amplifying GitHub tarball Kafka scaler with a filtered Prometheus trigger. | Rendered ScaledObject plus `TarballMetrics` emitter test |
