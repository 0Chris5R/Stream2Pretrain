...
@pytest.mark.parametrize(
    ...
    [
        ("arxiv-html-fetcher", "html", "arxiv-html-2026-06", "scientific_paper", "finepdfs_edu_v2", True),
        ("arxiv-html-backfill", "pdf", "docling-pdf-cpu-v1", "scientific_paper", "finepdfs_edu_v2", True),
        ("openreview", "pdf", "openreview-pdf-pending-marker", "scientific_paper", "finepdfs_edu_v2", True),
        ("openreview-live", "pdf", "docling-pdf-cpu-v1", "scientific_paper", "finepdfs_edu_v2", True),
        ("openreview-backfill", "markdown", "reviewarena-ocr-markdown-v1", "scientific_paper", "finepdfs_edu_v2", True),
        ("seed:allenai/peS2o", "latex", "pes2o-v3", "scientific_paper", "finepdfs_edu_v2", True),
        ("seed:togethercomputer/RedPajama-Data-1T", "latex", "redpajama-arxiv-v1", "scientific_paper", "finepdfs_edu_v2", True),
        ...
        ("seed:HuggingFaceFW/fineweb-edu", "html", "fineweb-edu-seed-v1", "web_prose", "fineweb_edu", True),
        ("seed:wayback", "web", "wayback-backfill-2026-06", "web_prose", "fineweb_edu", True),
        ("github-release-tarballs", "code", "github-release-tarball-2026-06", "source_code", "stack_v2_dolma_rules", True),
        ("seed:HuggingFaceTB/stack-edu", "code", "stack-edu-seed-v1", "source_code", "stack_v2_dolma_rules", True),
        ("github-release-tarballs", "web", "github-readme-markdown-v1", "repository_documentation", "fineweb_edu", True),
        ("hf-models", "web", "hf-model-card-markdown-v1", "hf_model_card", "fineweb_edu", True),
        ("hf-datasets", "web", "hf-dataset-card-markdown-v1", "hf_dataset_card", "fineweb_edu", True),
        ("hf-spaces", "web", "hf-space-card-markdown-v1", "hf_space_card", "fineweb_edu", True),
        ("openreview", "review", "openreview-review-text", "peer_review", "openreview_schema", True),
        ("openreview-live", "review", "openreview-review-json-v1", "peer_review", "openreview_schema", True),
        ("openreview-backfill", "review", "reviewarena-review-text", "peer_review", "openreview_schema", True),
        ("hf-daily-papers", "metadata", "hf-api-json-v1", "discovery_metadata", "not_applicable", False),
        ("arxiv-oai-cs", "metadata", "oai-pmh-metadata-v1", "discovery_metadata", "not_applicable", False),
        ("rss-arxiv-cs-cl", "metadata", "rss-arxiv-discovery-v1", "discovery_metadata", "not_applicable", False),
        ("rss-arxiv-cs-lg", "metadata", "rss-arxiv-discovery-v1", "discovery_metadata", "not_applicable", False),
        ("rss-arxiv-cs-ai", "metadata", "rss-arxiv-discovery-v1", "discovery_metadata", "not_applicable", False),
        ("rss-arxiv-cs-cv", "metadata", "rss-arxiv-discovery-v1", "discovery_metadata", "not_applicable", False),
        ("github-events", "metadata", "github-events-api-json-v1", "discovery_metadata", "not_applicable", False),
        ("github-releases", "metadata", "github-releases-atom-v1", "discovery_metadata", "not_applicable", False),
    ],
)
